...
const (
	...
	LatestKubeImage = "quay.io/brusdev/activemq-artemis-broker-kubernetes:artemis." + LatestVersion
	LatestInitImage = "quay.io/brusdev/activemq-artemis-broker-init:artemis." + LatestVersion
)
